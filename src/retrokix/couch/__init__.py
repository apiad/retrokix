"""retrokix couch — peer-to-peer plugin events over a tiny pub/sub bus.

A 'couch' is a set of retrokix instances connected to one broker — locally
...
from retrokix.couch.handle import (
    DEFAULT_SOCK,
    BrokerHandle,
    CouchHandle,
    ensure_local_broker,
...
from retrokix.couch.wire import read_frame, write_frame
