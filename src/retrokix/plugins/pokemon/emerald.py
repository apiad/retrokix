"""retrokix informational plugin — Pokémon Emerald companion.
...
in retrokix.plugins.pokemon.emerald_driver — load it explicitly to enable.
"""
...
from retrokix.plugins.pokemon.shared.scene import battle_phase
...
def _likely_moves(species: int, level: int):
    ...
    from retrokix.plugins.pokemon.shared.data import load_levelup
...
def http_weaknesses(ctx, species_id: int):
    from retrokix.plugins.pokemon.shared.data import load_species_info, load_types
    from fastapi import HTTPException
