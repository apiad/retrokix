...
See ``vault/Atlas/Architecture/2026-06-10-retrokix-scene-detection-design.md``
for the design rationale; the empirical session at
``vault/+/agent_drafts/handoffs/report-2026-06-10-1254-retrokix-scene-detection.md``
...
def find_memory_addresses(
    ...
    *,
    ...
    """
    from retrokix.state.capture import EWRAM_SIZE, IWRAM_SIZE
