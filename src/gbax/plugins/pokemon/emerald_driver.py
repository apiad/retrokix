"""gbax driver plugin — Pokémon Emerald automation.
...
Depends on gbax.plugins.pokemon.shared (not on the informational plugin
...
from gbax.plugins.pokemon.shared.scene import (
...
def _score_move_vs(types_list: list[int], move_type_name: str, power: int) -> float:
    ...
    from gbax.plugins.pokemon.shared.battle import _type_id_for_name
