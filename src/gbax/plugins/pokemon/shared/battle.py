...
from gbax.plugins.pokemon.shared.party import SPECIES_NAMES
from gbax.plugins.pokemon.shared.scene import in_battle
...
def battle_state_dict(runtime) -> dict:
    ...
    from gbax.plugins.pokemon.shared.data import load_moves, load_types
