...
TODO: rom_sha1 placeholder. Replace with `sha1sum <your-mk-advance-rom>`.
This scenario is real but cannot be `gbax tournament`-run until a real ROM
is acquired and the sha1 is filled in.
"""
